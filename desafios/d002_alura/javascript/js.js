function jogar(){
    ...
    if(idade >= 18){
        ...
        while(partidas < 3){
            let escolha_jogador = prompt("Digite: \n1 - PEDRA\n2 - PAPEL\n3 - TESOURA") //ESCOLHA DO JOGADOR

            let escolha_computador = Math.floor(Math.random() * 3) + 1
                //ESCOLHA DO COMPUTADOR
                if(escolha_computador == 1){
                    alert(`Eu vou colocar PEDRA`)
                } else if(escolha_computador == 2){
                    alert(`Eu vou colocar PAPEL`)
                } else {
                    alert(`Eu vou colocar TESOURA`)
                }
            
            if(escolha_jogador == 1 && escolha_computador == 3 || escolha_jogador == 3 && escolha_computador == 2 || escolha_jogador == 2 && escolha_computador == 1)/*POOSSÍVEIS GANHOS DO JOGADOR*/{
                alert("Parabéns você ganhou!!")
                partidas++
                ganho_jogador++
                alert(`O jogo está ${ganho_jogador} x ${ganho_camputador}`)
            } else if(escolha_computador == 1 && escolha_jogador == 3 || escolha_computador == 3 && escolha_jogador == 2 || escolha_computador == 2 && escolha_jogador == 1)/*POOSSÍVEIS GANHOS DO JOGADOR*/{
